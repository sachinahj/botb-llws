  ...
  return (
    <section className="content-section rules">
      ...
      <ol className="rules-list">
        ...
        <li><span>04</span><div><strong>Break ties</strong><p>World Champion ownership, best single-team finish, combined winning percentage, then combined run differential. A coin flip is the final fallback.</p></div></li>
      </ol>
